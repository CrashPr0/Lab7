...
HD_PWD='C:/Users/iSchool Admin/Documents/factorial_vivado_project/vivado/Lab7/Lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_top_pipe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3_top_pipe.tcl -notrace
