...
REM
REM Generated by Vivado on Mon Apr 27 11:46:20 -0700 2026
...
echo "xvlog --incr --relax -prj tb_mips_pipe_vlog.prj"
call xvlog  --incr --relax -prj tb_mips_pipe_vlog.prj -log xvlog.log
