...
REM
REM Generated by Vivado on Mon Apr 27 11:43:16 -0700 2026
...
echo "xvlog --incr --relax -prj tb_soc_pipe_vlog.prj"
call xvlog  --incr --relax -prj tb_soc_pipe_vlog.prj -log xvlog.log
